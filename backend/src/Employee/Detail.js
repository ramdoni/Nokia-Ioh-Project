                ...
                <div className="col-lg-12">
                    <div className="card">
                        <div className="header pb-0">
                            <div className="row">
                                <div className="col-md-2"><i className="fa fa-arrow-left text-info mr-2 ml-2"></i>  <label style={{fontSize:"18px"}}>Edit Employee</label></div>
                        ...
                        <div className="body">
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div className="form-group">
                                    ...
                                    <button type="submit" className="btn btn-info mx-2"><i className="fa fa-save"></i> Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
